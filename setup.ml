...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3b598ed451703ea1357d564c9252936a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Martin Lange"; "Maurice Herwig"];
          homepage = None;
          bugreports = None;
          synopsis = "A tool for discrete modelling in propositional logic";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "dimo.ml"})
            ];
     ...
     oasis_digest =
       Some "X\241S\221\210\161\210\031\145\233\244\233\172|\140\002";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
